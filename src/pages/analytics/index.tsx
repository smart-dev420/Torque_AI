    ...
    <div>
      ...
      <div className="grid grid-cols-12 gap-[32px]">
        ...
        >
          ...
          <div className="grid grid-cols-6 gap-[8px]">
            <div className="col-span-2">
              <ItemInfoList
                icon={<SendOutlinedIcon style={{ fontSize: "8px" }} />}
                title="Total Clicks"
                content="460,000"
              />
            </div>
          ...
          <div className="mb-[24px]">
            <button
              className="px-[12px]  rounded-[50px] Button w-[153px]"
              style={{
        ...
        >
          <div className="flex flex-row justify-between ">
            <label className="font-h3-700">
              Rising Trends and Outliers{" "}
              <ErrorOutlineIcon style={{ fontSize: "14px" }} />
            </label>
          </div>
          <div className="mb-[24px]">
            <div className="rounded-[2px] flex flex-col gap-[13px] mb-[16px]">
              <div className="Button">Green Investments</div>
              <div className="flex flex-row gap-[8px]">
                <ArrowOutwardOutlinedIcon
                  style={{ fontSize: "16px", color: "#4152EC" }}
                />
                <div className="font-b5-500 text-left">
                  Create content highlighting environmentally responsible
                  investment options like green REITs and sustainable stocks.
                </div>
              </div>
              <div className="flex flex-row gap-[8px] w-full">
                <ItemList
                  icon={<LeaderboardIcon style={{ fontSize: "12px" }} />}
                  title="Growth Rate"
                  content="+150% in the past 30 days"
                />
                <ItemList
                  icon={<VisibilityOutlinedIcon style={{ fontSize: "12px" }} />}
                  title="Top Channels"
                  content="LinkedIn, YouTube"
                />
              </div>

              <Divider style={{ height: "2px", color: "#000" }} />

              <div className="Button">Crypto Diversification</div>
              <div className="flex flex-row gap-[8px]">
                <ArrowOutwardOutlinedIcon
                  style={{ fontSize: "16px", color: "#4152EC" }}
                />
                <div className="font-b5-500 text-left">
                  Promote content focusing on diversified crypto portfolios,
                  targeting younger investors interested in spreading risk.
                </div>
              </div>
              <div className="flex flex-row gap-[8px] w-full">
                <ItemList
                  icon={<LeaderboardIcon style={{ fontSize: "12px" }} />}
                  title="Growth Rate"
                  content="+120% in the past 60 days"
                />
                <ItemList
                  icon={<VisibilityOutlinedIcon style={{ fontSize: "12px" }} />}
                  title="Top Channels"
            ...
            <button
              className="px-[12px]  rounded-[50px] Button w-[113px]"
              style={{
                backgroundColor: themeContext?.theme.activeButtonBackground,
                color: themeContext?.theme.activeColor,
                position: "absolute",
        ...
        >
          <div className="flex flex-row justify-between ">
            <label className="font-h3-700">
              Audience Insights and Best Times to Engage{" "}
              <ErrorOutlineIcon style={{ fontSize: "14px" }} />
            </label>
          </div>

          <div className="mb-[24px] flex flex-row gap-[16px]">
            <div className="rounded-[2px] flex flex-col gap-[13px]">
              <div className="Button">Top Demographics</div>
              <div className="flex flex-row gap-[8px]">
                <ArrowOutwardOutlinedIcon
                  style={{ fontSize: "16px", color: "#4152EC" }}
                />
                <div className="font-b5-500 text-left">
                  Your audience is most engaged with video content during
                  morning commutes and evening hours. Capitalize on this by
                  scheduling posts during these times.
                </div>
              </div>
              <div className="flex flex-row gap-[8px] w-full">
                <ItemList
                  icon={<PeopleAltOutlinedIcon style={{ fontSize: "12px" }} />}
                  title="Age 25-34"
                  content="35% of total audience"
                />
                <ItemList
                  icon={<PeopleAltOutlinedIcon style={{ fontSize: "12px" }} />}
                  title="Age 35-44"
                  content="28% of total audience"
                />
              </div>
              <ItemList
                icon={<LocationOnOutlinedIcon style={{ fontSize: "12px" }} />}
                title="Top Locations"
                content="New York, San Francisco, London"
              />
            ...
            <div className="shrink-0 w-1/2 flex flex-col gap-[8px]">
              <div
                className="flex flex-row justify-between items-center p-2 rounded-[8px]"
                style={{
                  backgroundColor: themeContext?.theme.hoverBackground,
                  border: `1px solid ${themeContext?.theme.hoverColor}`,
                }}
              >
                <p className="Button">Top Performance</p>
                <div className="flex flex-row gap-[8px] items-center">
                  <ArrowCircleUpOutlinedIcon
                    style={{ fontSize: "16px", color: "#4152EC" }}
                  />
                  <p className="Button">Tuesday</p>
                  <ArrowCircleUpOutlinedIcon
                    style={{ fontSize: "16px", color: "#4152EC" }}
                  />
                  <p className="Button">9 am</p>
                </div>
              </div>
              <div className="flex flex-row items-end justify-between w-full h-[90px] gap-x-[10px]">
                <ChartItem value={31} str="12 am" />
                <ChartItem value={47} str="3 am" />
                <ChartItem value={31} str="6 am" />
                <ChartItem value={17} str="12 pm" />
                <ChartItem value={35} str="3 pm" />
                <ChartItem value={57} str="6 pm" />
                <ChartItem value={67} str="9 pm" />
              </div>
              <div className="flex flex-row items-end justify-between w-full h-[90px] gap-x-[10px]">
                <ChartItem value={31} str="Mon" />
                <ChartItem value={47} str="Tue" />
                <ChartItem value={31} str="Wed" />
                <ChartItem value={17} str="Thr" />
                <ChartItem value={35} str="Fri" />
                <ChartItem value={57} str="Sat" />
                <ChartItem value={67} str="Sun" />
              </div>
          ...
          <button
            className="px-[12px]  rounded-[50px] Button w-[135px]"
            style={{
          ...
          <button
            className="px-[12px]  rounded-[50px] Button w-[143px]"
            style={{
              backgroundColor: themeContext?.theme.activeButtonBackground,
              color: themeContext?.theme.activeColor,
              position: "absolute",
...
const ChartItem: React.FC<{ value: number; str: string }> = ({
  value,
  str,
}) => {
  return (
    <div className="flex flex-col items-center gap-y-2 w-[35px]">
      <div
        className="w-[12px]"
        style={{
          height: `${value}px`,
