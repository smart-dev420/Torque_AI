                    ...
                    <div style={{ backgroundColor: themeContext?.theme.foreground }} className="flex flex-col gap-[16px] p-[24px]">
                        ...
                        <div className="flex flex-col gap-[16px] p-[16px] rounded-[4px]" style={{ backgroundColor: themeContext?.theme.inputBackground }}>
                            ...
                            <div className="flex flex-col md:flex-row gap-[8px] w-full" >
                                <div className="flex flex-row gap-[8px] p-[16px] md:w-1/2 items-center" style={{ backgroundColor: themeContext?.theme.activeColor }}>
                                    <FBIcon/>
                            ...
                            <div className="flex flex-col md:flex-row gap-[8px] w-full" >
                                <div className="flex flex-row gap-[8px] p-[16px] md:w-1/2" style={{ backgroundColor: themeContext?.theme.activeColor }}>
